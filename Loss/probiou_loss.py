...
"""
在某些情况下，特别是当两个框的宽高比差异非常大时，CIoU 可能会产生负值。
负值可能影响损失函数的计算，尤其是在需要 CIoU 作为正向梯度的情况下，可能导致优化过程中的问题。
"""
...
if __name__ == "__main__":
    ...
    obb2 = torch.tensor([[5.0, 5.0, 6.0, 2.0, math.radians(45)]])  # [x, y, w, h, r=45°]
    print("OBB1:", obb1)
    print("OBB2:", obb2)
    ...
    a1, b1, c1 = _get_covariance_matrix(obb1)
    a2, b2, c2 = _get_covariance_matrix(obb2)
    print("OBB1的协方差分量:", a1, b1, c1)
    print("OBB2的协方差分量:", a2, b2, c2)
